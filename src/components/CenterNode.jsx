  ...
  return (
    <group ref={groupRef} position={[0, 0, 0]}>
      ...
      <mesh ref={coreWireframeRef}>
        ...
        <meshBasicMaterial color="#898989" wireframe={true} transparent opacity={0.05} toneMapped={false} />
      </mesh>
      ...
      <mesh ref={coreWireframeInnerRef}>
        ...
        <meshBasicMaterial color="#898989" wireframe={true} transparent opacity={0.03} toneMapped={false} />
      </mesh>
